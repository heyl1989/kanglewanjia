...
public class NurseComeOrderListActivity extends BaseActivity {
    ...
    private NurseComeOrderListAdapter orderListAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nurse_come_order_list);
...
//        border.setBackgroundResource(R.drawable.border_highlight);
        orderListAdapter = new NurseComeOrderListAdapter();
...
//                    showTost("选中取消订单了");
    ...
    class NurseComeOrderListAdapter extends RecyclerView.Adapter<NurseComeOrderListAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_nurse_come_order, parent, false);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    goNewActivity(NurseComeOrderDetailActivity.class);
                }
            });
