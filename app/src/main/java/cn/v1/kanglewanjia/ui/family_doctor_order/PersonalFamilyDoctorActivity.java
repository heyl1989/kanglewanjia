...
public class PersonalFamilyDoctorActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_family_doctor);
...
//                linearLayoutManager.scrollToPositionWithOffset(position,350);
    ...
    class FamilyDoctorAdapter extends RecyclerView.Adapter<FamilyDoctorAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_personal_family_doctor, parent, false);
