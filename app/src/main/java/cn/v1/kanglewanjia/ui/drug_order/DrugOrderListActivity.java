...
public class DrugOrderListActivity extends BaseActivity {
    ...
    private MedicalOrderListAdapter orderListAdapter;
...
//        border.setBackgroundResource(R.drawable.border_highlight);
        orderListAdapter = new MedicalOrderListAdapter();
...
//                    showTost("选中取消订单了");
    ...
    class MedicalOrderListAdapter extends RecyclerView.Adapter<MedicalOrderListAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_drug_order, parent, false);
