...
public class Util {
    ...
    private static String getMacAddress(){
        String macAddress = "";
        try {
            @SuppressLint("WifiManagerLeak") WifiManager wfm = (WifiManager)App.getInstance().getSystemService(Context.WIFI_SERVICE);
    ...
    private static String getUUID(){
        if(TextUtils.isEmpty((String) SPUtil.get(App.getInstance(), Common.KEY_UUID,""))){
            SPUtil.put(App.getInstance(),Common.KEY_UUID, UUID.randomUUID().toString());
        }
        return (String) SPUtil.get(App.getInstance(), Common.KEY_UUID,"");
    }
